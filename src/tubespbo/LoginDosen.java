...
public class LoginDosen extends javax.swing.JFrame {
    ...
    private void loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginActionPerformed
        ...
        try{
            ...
            String sql = "SELECT NIP,Password_Dosen FROM dosen_koordinator WHERE NIP='"+user.getText()+"' AND Password_Dosen='"+password.getText()+"'";
            ResultSet res = stat.executeQuery(sql);

            // penelusuran baris pada tabel Dosen dari database
            if(res.next()){
                if (user.getText().equals(res.getString("NIP")) && password.getText().equals(res.getString("Password_Dosen"))){
